...
**ArTisT'TE:** `lcp-onculuk-kapisi` 1 adim (3. kez ayni: `:406` rc=2, **5 mutant**/≥12, A2/A3 kirmizi).
✅ **`KraL-FiyatDar-6Eyl` BITTI** `[Opus 5]` — `FIYAT_GIRDI_RX` = `d3dd8f6d` (birebir). Ikiz kapiya **MENZIL ekseni** eklendi: 3 sinir vakasi (`500.123 TL`·`0.5 TL`·`0,5 TL`) + `--kendini-test` (batarya + **10 mutant**, IZOLE kokte) `nobet.yml`e baglandi. **11/11** · M7 (`[1-9]`→`[0-9]`, `0.5 TL`→`1 TL`) 12/12 → **10/12 KIRMIZI** · panel **227/227**.
