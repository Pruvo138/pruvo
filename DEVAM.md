...
- 🔧 **ACIK:** ① **17 merge EDILMEMIS `claude/*` dali** — envanter `DEVAM-ARSIV.md`'de, **SILINMEZ**; 2'sinin uzak kopyasi YOK (`adoring-dewdney-210333` · `eager-shtern-b4ec5c`), depo PUBLIC → denetlenmeden itilmez · ② SERIT B 7 adim kirmizi (yayini BLOKLAMAZ) → cip `determined-cray-0c858d` · ③ cip `KraL-ImpellerB-Kapanis` · ④ cip `KraL-KutuRotasyon-Sinif` [Sonnet 5] (beyani arac yazsin · sha ayrac korlugu · KORUMA-DUSTU · K389 kardesi).
