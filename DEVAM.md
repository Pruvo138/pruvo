...
- **URUN EKSENI ✅ KAPANDI — MERGE `69400ad9` + YAYIN INDI** (run `34363440627`, `deploy`+`yayin` success, SKIPPED 0): uc ekleyicinin icerik adimi EMEKLI motordan koparildi (`urun_icerik_det.py`), MaCiT'in 299 adaylik blokaji KALKTI. Bagimsiz olcum dalin agacinda: det-test 9/9 tuketici · thing-icerik-test canli mutant · ci-kapsam rc=0 · d1-sync 36.285==36.285. 🔴 `MODEL` sabiti BILEREK degismedi (emekli pencere 20 Agu'da kapandi) → BaBa'nin kabul olcutu ① KARSILANMADI, hukum BaBa'da. K398 duzeltildi: `rc=0` onculum BORU hatasiydi, gercek kusur bayat `oneri.json`.
