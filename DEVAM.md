...
✅ **`KraL-D1Yayin-6Eyl` BITTI** (merge `96a34189`) — **TAM METIN `DEVAM-ARSIV.md`'de** (6 Eyl ROTASYON, md5 birebir): 4 adim yesil; kok → [[iki-kollu-govde-tek-sabite-capalanirsa-kosucunun-diskini-olcer]].
