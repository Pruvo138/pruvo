...
- **K388 META ATIF (ArTisT):** CAPI'nin 3 kaleminden 2'si ZATEN kapali; 4,4/10 `em`/`ph` KARARININ fiyati, ariza DEGIL. Acik kalem **ATIF**: `fbc` riza kapisinin arkasinda, toplama ACIK / cikis KAPALI. Kabul: D1 `siparis` 30 gun SAYIM (toplam·`atif`·`fbp`·`fbc`·`ga_client_id`·`utm`). OLCULEMEDI: sayim (kota RED). Okan/BaBa: `em`/`ph` gonderilsin mi.
