...
## ✅ 26 EYL 17:xx KraL ana-oturum — **MARKA SÖZLÜĞÜ 14. TUR MAIN'DE (`c7669344`): Pentax · Olympus · Leica · Blackmagic · Insta360 · parite OLCULEMEDI (eşzamanlı ekleme kayması)**
**SIRADAKİ TEK İŞ:** MaCiT push'ları durulunca ana checkout güncel main'de `node tools/parite-test.js` + `node tools/parite-ege.js` BORUSUZ → rc=0 (bu merge'ün açık kabulü). Ardından açık kalem: CI dışı `mimar-kilit-test`/`mutasyon` kırmızısı.
