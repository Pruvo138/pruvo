# SPEC — K257 TUR 2: geri al → yeniden uygula → ölç (İŞÇİ TURU, mekanik)
...
Kanıt dizini: `/Users/okan/.claude/cron/k257-kanit2` (yoksa oluştur)
...
```
python3 /Users/okan/dev/pruvo/.claude/worktrees/silly-mendel-3965d4/tools/k257/k257-kur.py --geri-al 20260820T162216Z
```
→ `/Users/okan/.claude/cron/k257-kanit2/01-geri-al.txt`
...
```
→ `/Users/okan/.claude/cron/k257-kanit2/02a-taban-kabul.txt`

```
python3 /Users/okan/.claude/cron/nobet-kapi-mutasyon.py
```
→ `/Users/okan/.claude/cron/k257-kanit2/02b-taban-mutasyon.txt`

```
python3 /Users/okan/.claude/cron/nobet-tetik-test.py
```
→ `/Users/okan/.claude/cron/k257-kanit2/02c-taban-tetik.txt`

```
python3 /Users/okan/dev/pruvo/tools/nobet-sayac-durustluk-test.py
```
→ `/Users/okan/.claude/cron/k257-kanit2/02d-taban-sayac-durustluk.txt`
...
```
→ `/Users/okan/.claude/cron/k257-kanit2/03a-pycompile.txt`

```
python3 /Users/okan/dev/pruvo/.claude/worktrees/silly-mendel-3965d4/tools/k257/k257-kur.py
```
→ `/Users/okan/.claude/cron/k257-kanit2/03b-once.txt`
...
```
→ `/Users/okan/.claude/cron/k257-kanit2/04-uygula.txt`
...
```
→ `/Users/okan/.claude/cron/k257-kanit2/05-sozdizimi.txt`
...
```
→ `/Users/okan/.claude/cron/k257-kanit2/06-k257-kabul.txt`
...
```
→ `/Users/okan/.claude/cron/k257-kanit2/07-kuru-tur.txt`
...
python3 /Users/okan/.claude/cron/nobet-kabul-test.py
```
→ `/Users/okan/.claude/cron/k257-kanit2/08a-sonra-kabul.txt`

```
python3 /Users/okan/.claude/cron/nobet-kapi-mutasyon.py
```
→ `/Users/okan/.claude/cron/k257-kanit2/08b-sonra-mutasyon.txt`

```
python3 /Users/okan/.claude/cron/nobet-tetik-test.py
```
→ `/Users/okan/.claude/cron/k257-kanit2/08c-sonra-tetik.txt`

```
python3 /Users/okan/dev/pruvo/tools/nobet-sayac-durustluk-test.py
```
→ `/Users/okan/.claude/cron/k257-kanit2/08d-sonra-sayac-durustluk.txt`

## ADIM 9 — N4B kardeş bataryaları

```
python3 /Users/okan/.claude/cron/nobet-sayac-cikis-yollari-test.py
```
→ `/Users/okan/.claude/cron/k257-kanit2/09a-b8.txt`

```
python3 /Users/okan/.claude/cron/nobet-tur-izolasyon-test.py
```
→ `/Users/okan/.claude/cron/k257-kanit2/09b-b7.txt`

```
python3 /Users/okan/.claude/cron/nobet-kosum-hukmu-test.py
```
→ `/Users/okan/.claude/cron/k257-kanit2/09c-b5.txt`

```
python3 /Users/okan/.claude/cron/nobet-icra-hali-test.py
```
→ `/Users/okan/.claude/cron/k257-kanit2/09d-b6.txt`

```
python3 /Users/okan/.claude/cron/nobet-eskalasyon-bayat-test.py
```
→ `/Users/okan/.claude/cron/k257-kanit2/09e-b4.txt`
...
```
→ `/Users/okan/.claude/cron/k257-kanit2/10-artik.txt`
...
KANIT_DIZINI=/Users/okan/.claude/cron/k257-kanit2
```
