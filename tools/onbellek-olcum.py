...
def cf_get(yol, token):
    ...
    try:
        ...
        # token dosyasi token degil serbest metin tasiyabilir (or. hatirlatma notu);
        # basliga sigmayan deger istegi kurulamaz — bolum D olculemez ama A/B/E hukmu duser olmaz
        return 0, "ISTEK-KURULAMADI(token gecersiz gorunuyor): " + repr(e)
