...
MUTANTLAR = [
    ...
    # --- ÇAPRAZ ENVANTERİN SINIF EKSENİ — K19 sınıf imzası (19 Ağu, K202; K205 ile main'e taşındı) ---
    ...
    # Çapa main'in MEVCUT gövdesinden türetildi (K205 T2, bayat-çapa dersi): count==1 ölçüldü.
    ("tools/arama.py",
     '"Vespa|smallframe": ("ROZET",',
     '"Vespa|smallframe": ("BEKLER",',
     "KIRMIZI",
