...
═══════════════════════════════════════════════════════════════════════════════
  AD EKSENI (ozet)     : normalize edilmis mesajda, KELIME BASINDAN baslayan ve desen
                         ...
                         taranir: (1) bosluklu normal akis ("gizliad nun" gibi ek/
                         noktalama ayrilmis yazimlar), (2) sikistirilmis akis (bosluklar
                         atilmis: "gizli ad" -> "gizliad"). Ek/noktalama ve
...
# (ğ->g, ş->s, ç->c, ö->o, ü->u, İ->i). `ı` ayrisMAZ -> elle eslenir. Amac: "Gizliad",
# "GIZLIAD", "gizliad'nun" ayni normal bicime insin.
...
def adaylar(metin, uzunluk):
    ...
    IKI AKIS BILEREK: bosluklu akis "gizliad nun" gibi ek/noktalama ayrilmis yazimi,
    sikistirilmis akis ise "gizli ad" gibi AYRIK yazilmis bitisik adi yakalar."""
    if uzunluk <= 0:
        return set()
