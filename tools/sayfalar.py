...
<p>Bu sayfa tek bir parçaya kilitli: dolap ve vitrin yan panelindeki deliğe giren raf pimi ve raf tutucusu. Kapak menteşesi, kulp ve dolap ayağı bu kapsamın dışında kalır.</p>
<h2>Sipariş</h2>
...
<h2>Dürüst sınır</h2>
<p>Ne üretiriz: kapağı kapalı tutan mandal gövdesi, esneyen kilit dili ve onun oturduğu karşı tırnak ya da yuva. Dolap, çekmece, alet çantası, kutu, muhafaza kapağı, pano kapağı gibi yerlerde ölçüye özel plastik mandal kilit dili yaptırma işini rahatlıkla yaparız.</p>
...
<li><strong>Tutamak yuvasına oturan pim/burç çapı ve oturma derinliği:</strong> tutamağın kabin üzerindeki yuvada boşluk yapmadan sabit durması içindir.</li>
...
<p>Salonda ya da evde bir kondisyon aletinin en zayıf halkası genelde metal aksamı değil, gövdeyi saran plastikleridir. Koşu bandının motor kapağı, ağırlık kolonunun halat kılavuzu kılıfı, seçme piminin oturduğu yuva, gövde borusunun ayak pabucu; hepsi tekrarlı hareket, ter ve darbe görür. Terin taşıdığı tuz ve nem yüzeyde kalır, temizlik bezi her gün aynı kenara sürtünür, ağırlık bırakıldığında gövdeye kısa ve sert bir darbe biner. Plastik bu üç yükü aynı anda taşıdığında önce tırnaktan, sonra vida kulağından çatlar. Kırıldığında tedarik tarafı çoğu zaman kapanmıştır: eski seri için ayrılan yedek stok birkaç sezonda tükenir. Geriye kalan tek şey elinizdeki kırık örnektir.</p>
...
<li><strong>Klips gövde çapı ve tırnak yüksekliği:</strong> Tırnak, sac kalınlığına göre ayarlanır; kalın sacta kısa tırnak tutmaz, ince sacta uzun tırnak paneli gevşek bırakır.</li>
...
<li><strong>Tırnak esneme payı ve kök yarıçapı:</strong> Tırnağın açılıp geri gelmesini bu pay sağlar; köşe yuvarlatması olmayan tırnaklar genellikle aynı yerden kırılır.</li>
...
<h2>Dürüst sınır</h2>
<p>Ne üretiriz: kuru ya da hafif yağlı çalışan, orta hızlı ve orta yüklü sürtünme yüzeyleri — kızaklar, kaydırıcılar, aşınma plakaları, kılavuz dilleri, tırnaklı tutucular, yatak yüzeyleri.</p>
...
<p>Ölçüleri aldıktan sonra size hangi payla çalışacağımızı söyleriz: pim yuvada dönecekse serbest geçme, sabit duracaksa sıkı geçme. Onayınızdan sonra parçayı üretir, gerekirse ilk parçayı deneme olarak gönderip oturmasını teyit ederiz. Ölçü sizden, üretim bizden — bu akış boyunca sizden istediğimiz tek şey birkaç doğru rakamdır.</p>
<h2>Ölçünüze göre ayarladığımız seçenekler</h2>
<ul>
...
<li><strong>Geçme payı (tolerans):</strong> Dönen pimde bir miktar boşluk, sıkı oturması gereken pimde ise sıfıra yakın pay veririz. Aynı çapta iki pim, payı yüzünden büsbütün farklı davranır.</li>
...
<p>Kırılan parçanın tırnak mı yoksa kilitleyen bir dil mi olduğundan emin değilseniz <a href="/olcuye-ozel-mandal-kilit-dili-uretimi/">ölçüye özel mandal ve kilit dili üretimi</a> sayfasına da göz atın; aynı arızanın iki farklı adıdır. Kapağı tutan eleman ayrı bir gövdeye geçen bir parçaysa <a href="/olcuye-ozel-klips-kelepce-uretimi/">ölçüye özel klips ve kelepçe üretimi</a> sayfası daha uygun olabilir. Kırılan yalnızca tırnak değil de parçanın gövdesiyse <a href="/kirik-plastik-parca-yaptirma/">kırık plastik parça yaptırma</a> sayfasında genel akışı bulursunuz; ölçüyü kendiniz almak isterseniz <a href="/parca-olcusu-nasil-alinir-ve-gonderilir/">parça ölçüsü nasıl alınır ve gönderilir</a> rehberi elinizden tutar.</p>""")
...
<p>Ölçüleri çıkarıp size ayarları teyit ettiririz: kaç milimetre kanal, kaç milimetre dönüş yarıçapı, hangi delik aralığı. Bu adım önemlidir, çünkü yenmiş numunenin ölçüsü zaten aşınmış ölçüdür; biz aşınma payını geri ekleyerek ilk günkü kotu hedefleriz. Onaydan sonra parça özel olarak üretilir ve tek adet de olsa aynı özenle hazırlanır. Aynı hatta ileride yine gerekirse ölçü kaydı bizde durur, ikinci siparişte ölçü alma adımını tekrarlamayız.</p>
<h2>Ölçünüze göre ayarladığımız seçenekler</h2>
<ul>
...
<h2>Doğru malzeme</h2>
<p>Malzemeyi parçanın çalıştığı yere göre seçeriz, listenin en üstünü satmaya çalışmayız. Kuru ortamda, düşük hızda ve hafif ürün taşıyan bir kılavuzda standart sınıf çoğu zaman yeterlidir; gereksiz üst sınıfa itmek maliyeti şişirir, hattı daha iyi çalıştırmaz.</p>
...
<h2>Dürüst sınır</h2>
<p>Açık konuşalım: neyi üretebileceğimizi olduğu kadar neyi üretemeyeceğimizi de söyleriz. Kılavuz çıtayı, yan tutucuyu, kızak profilini, zincir kılavuzunu, makara gövdesini, gergi ve ayar aparatlarını ölçüsüne göre üretiriz. Taşıyıcı bandın veya zincirin kendisini, çelik mili, aksı ve rulmanın metal iç yapısını üretmeyiz — hazır rulmanın oturacağı yuvayı ise ölçüsüne göre veririz.</p>
...
<h2>Doğru malzeme</h2>
<p>Havuz çevresi bizim için üç kademeli bir seçim demek. Standart sınıf, yalnızca gölgede duran, su ile sürekli teması olmayan ve yük almayan yardımcı parçalar için yeterlidir; buraya kimseyi zorla üst sınıfa itmeyiz, çünkü fiyatı büyütmenin anlamı yoktur.</p>
...
<p>Üzerine yük binen, sürtünen ya da vida dişi taşıyan parçalarda karbon veya cam elyaf takviyeli sınıflara çıkarız (PA-CF / PA-GF). Süpürge tekerleği aksı, merdiven tutucusu ve sürekli açılıp kapanan mandal dili bu kademenin tipik örnekleridir.</p>
<h2>Dürüst sınır</h2>
...
<p>Aynı arıza kamyon ve ticari araçlarda daha sık görülür ve yedeği çok daha zor bulunur; filo aracınız varsa <a href="/ticari-arac-kamyon-plastik-parca-ozel-uretim/">kamyon ve ticari araç kabin plastikleri sayfamıza</a> bakmanızı öneririz. Kapı panelindeki kaplama ve tespit elemanları için <a href="/oto-ic-trim-klips-parca-uretimi/">oto iç trim ve klips üretimi sayfamız</a>, elinizdeki numuneden üretimin genel işleyişi için de <a href="/numuneye-gore-plastik-parca-uretimi/">numuneye göre plastik parça üretimi sayfamız</a> yol gösterir.</p>""")
...
<p>Bir parçanın ömrünü çoğu zaman parçanın kendisi değil, içinde çalıştığı ortam belirler. Soğuk bir sabahta rölantide titreyen bir motor kapağı, gün içinde ısınıp akşam serinleyen bir dış gövde, yıkama suyunun ve nemin sürekli girdiği bir yuva, temizlik kimyasalının damladığı bir tutamak... Bu koşulların hepsi malzemeyi yorar; yorulmuş malzeme ise ilk ciddi çarpmada kırılır. Aynı yerden ikinci, üçüncü kez kopan bir parça size şunu söyler: mesele tek bir talihsiz darbe değil, çoğu kez malzeme sınıfı ve o bölgenin ölçüsüdür.</p>
<p>Darbeye dayanıklı plastik parça yaptırma talebiyle bize gelen işlerin büyük kısmı tam olarak böyle geliyor. Elde kırık bir parça var, aynısı daha önce de kırılmış, çoğu zaman kırık yüzeyler cam gibi düz. Bu, malzemenin çatlağı yutmak yerine anında ilettiğini gösterir. Tok plastik parça üretiminde amaç, gelen enerjiyi kopma yerine hafif esneme ve şekil değiştirme ile karşılayabilen bir sınıfa geçmektir. Bu işi soran çoğu kişi "kırılmaya dayanıklı plastik parça yaptırma" diyor; kastedilen genelde budur — sınırsız bir dayanım vaadi değil, aynı darbede pes etmeyen daha tok bir malzeme ve doğru kesit.</p>
<h2>Nasıl çalışır: getir, ölç, üret</h2>
...
<p>Darbe sorununun en görünür olduğu alanlardan biri kondisyon aletleridir; düşen ağırlığın ve sürekli yüklenen kolun altında çalışan parçalar için <a href="/spor-salonu-fitness-ekipmani-plastik-parca-uretimi/">fitness ekipmanı plastik parça üretimi</a> sayfamıza da göz atın. Malzeme sınıflarının tamamını yan yana görmek isterseniz <a href="/malzeme-rehberi/">malzeme rehberimiz</a> ısı, dış mekân ve mukavemet eksenlerini birlikte karşılaştırır. Parçanız çarpmadan değil de zamanla incelerek yıpranıyorsa doğru sayfa <a href="/asinmaya-dayanikli-surtunme-parcasi-uretimi/">aşınmaya dayanıklı parça üretimi</a>. Ölçüyü nasıl alacağınızdan emin değilseniz <a href="/parca-olcusu-nasil-alinir-ve-gonderilir/">parça ölçüsü alma ve gönderme</a> anlatımı yol gösterir.</p>""")
...
<h2>Doğru malzeme</h2>
<p>Malzemeyi parçanın çalıştığı yere göre seçeriz, otomatik olarak en üst sınıfa itmeyiz. Kapak içinde kalan, güneş görmeyen ve düşük yük taşıyan bir tutucu için standart sınıf yeterlidir; gereksiz maliyeti size yüklemeyiz.</p>
...
<p>Kapsam dışı tuttuğumuz kısım kesici organ ve metal tahrik aksamıdır. Bıçak, bıçak tutucu metal göbek, misinanın kendisi, kavrama ve metal tahrik mili bu sayfanın konusu dışındadır; kesici organa doğrudan tork ileten bir parçayı plastik muadille değiştirmeyi de önermeyiz. Bunlar güvenlik parçalarıdır ve yerine geçecek malzeme sınıfı ayrıdır. Ölçü sizden, üretim bizden; sınırı da işin sonunda değil, ilk konuşmada söyleriz.</p>
<h2>Sipariş</h2>
...
<p>Elektrikli el aletlerindeki benzer sorunlar için <a href="/elektrikli-supurge-aparati-plastik-parca-uretimi/">elektrikli süpürge aparatı ve hortum bağlantı bileziği üretimi</a> sayfamıza göz atabilirsiniz; kırılan aparat ve bağlantı mantığı burada anlattığımızla aynıdır. Traktör ve tarla ekipmanına ait parçalar için <a href="/tarim-makinesi-plastik-parca-uretimi/">tarım makinesi plastik parça üretimi</a>, sürekli güneş altında kalan dış mekân parçaları için <a href="/uv-gunes-dayanikli-dis-mekan-plastik-parca-uretimi/">UV ve güneşe dayanıklı dış mekân parçası seçenekleri</a> ayrı ayrı anlatılıyor. Numuneyi bize ulaştırmadan önce <a href="/parca-olcusu-nasil-alinir-ve-gonderilir/">parça ölçüsü nasıl alınır ve nasıl gönderilir</a> sayfasındaki kısa yönergeyi okumanız süreci hızlandırır.</p>""")


def _ozel_parca_kac_gunde_hazir_olur():
    return (u"""<h1>Ölçü onayından gönderime kadar hangi kademe ne kadar sürüyor</h1>
...
<p>Net cevap şu: özel üretim teslim süresi tek bir rakam değil, birbirini izleyen dört kademenin toplamıdır. Ölçünün bize ulaşması, ölçünün teyidi, üretim ve gönderim. Aşağıda her kademenin gerçekçi aralığını ve süreyi uzatan etkenleri açık yazıyoruz; böylece ölçüye özel parça süresi konusunda tahmin yürütmek yerine takviminizi kurabilirsiniz.</p>
<h2>Nasıl çalışır: getir, ölç, üret</h2>
<p><strong>1. Ölçü ya da numunenin bize ulaşması — 0 ile 2 gün.</strong> Kırık parçanın fotoğrafını ve kumpas ölçülerini WhatsApp'tan iletirseniz bu kademe aynı gün kapanır. Parçayı fiziken göndermeyi seçerseniz süre gönderim hızına bağlıdır. Elinizde hiç ölçü yoksa, ölçü alma yöntemini anlatan sayfamızdaki sırayı izlemeniz çoğu parçada kısa sürede sonuç verir.</p>
<p><strong>2. Teyit — genellikle aynı gün ya da ertesi iş günü.</strong> Ölçüleri okur, tutmayan veya eksik kalan yerleri size sorarız. Delik aralığı, cidar kalınlığı, diş ölçüsü gibi kritik değerlerden biri eksikse iş burada durur ve teyit yazışması bir tur uzar. Yedek parça üretim süresini en çok uzatan kademe budur; çünkü tahmin ederek ilerlemeyi doğru bulmuyoruz.</p>
<p><strong>3. Üretim — tipik olarak 1 ile 4 iş günü.</strong> Tek adet küçük bir parça çoğu zaman 1-2 iş gününde tamamlanır. Ölçüsü büyük, cidarı kalın ya da adedi yüksek işler bu aralığın üst ucuna yaklaşır. Yoğun dönemlerde tarih verirken bunu hesaba katar, size gerçekçi bir gün söyleriz.</p>
<p><strong>4. Gönderim — 1 ile 3 gün.</strong> Üretim biter bitmez aynı gün ya da ertesi gün yola çıkar. Şehirler arası mesafe ve teslim noktası bu aralığı belirler.</p>
<p>Toplamda, ölçüsü tam gelen tek adet bir parçada olağan tablo 3-6 iş günüdür; ölçü eksikse ya da revizyon gerekiyorsa 7-10 iş günü aralığına çıkabilir. Tarihi siparişten önce, ölçünüz elimize geçtikten sonra veririz.</p>
<h2>Ölçünüze göre ayarladığımız seçenekler</h2>
...
<li><strong>Delik çapı ve delikler arası mesafe.</strong> Montajın tutması buna bağlıdır; yanlış gelen bir delik mesafesi doğrudan bir revizyon turu, yani birkaç gün demektir.</li>
<li><strong>Diş ölçüsü ve adımı.</strong> Vidalı bağlantılarda dişin standardı bilinmiyorsa numune isteriz; bu da ölçü kademesine gün ekler.</li>
...
CONTENT_PAGES = [
    ...
    ('plastik-stoper-durdurucu-yaptirma', 'Plastik Stoper Yaptırma: Ölçüye Özel Hareket Durdurucu', 'Aşınan ya da kırılan stoper yüzünden tüm mekanizmayı değiştirmeyin. Hareket durdurucuyu yükseklik, çap ve vida deliği ölçüsüyle üretiyoruz; ölçünüzü iletin.', _plastik_stoper_durdurucu_yaptirma),
    ('konveyor-bant-plastik-parca-yaptirma', 'Konveyör Bant Plastik Parçası Yaptırma: Kılavuz ve Kızak', 'Konveyör kılavuz çıtası, yan tutucu, kızak ve makara gövdesi numuneden ölçüye özel üretilir. Kanal, yarıçap, delik aralığı sizden; ölçü gönderin, üretelim.', _konveyor_bant_plastik_parca_yaptirma),
    ('havuz-ekipmani-plastik-parca-yaptirma', 'Havuz Ekipmanı Plastik Parça Yaptırma: Ölçüye Özel Yedek', 'Havuz süpürgesi tekerleği, skimmer kapak mandalı, merdiven tutucusu: kırık numuneden ölçüye özel üretiyoruz. Klorlu su ve güneşe uygun sınıf seçimi. Ölçünüzü yazın.', _havuz_ekipmani_plastik_parca_yaptirma),
    ('cam-krikosu-plastik-parcasi-yaptirma', 'Cam Krikosu Plastik Parçası Yaptırma: Kızak ve Tutucu', 'Cam inip kalkmıyorsa arıza çoğu zaman motorda değil, kırılan plastik kızak ve tutucudadır. Numunenizden ölçüye özel yenisini üretiyoruz; ölçünüzü bize iletin.', _cam_krikosu_plastik_parcasi_yaptirma),
    ('darbeye-dayanikli-plastik-parca-yaptirma', 'Darbeye Dayanıklı Plastik Parça Yaptırma: Tok Malzeme Seçimi', 'Aynı plastik parça hep aynı yerden mi kırılıyor? Darbeye dayanıklı plastik parça yaptırma için malzeme sınıfını ve kesiti birlikte seçelim, ölçünüzü gönderin.', _darbeye_dayanikli_plastik_parca_yaptirma),
    ('cim-bicme-bahce-makinesi-plastik-parca-yaptirma', 'Çim Biçme Makinesi Plastik Parça Yaptırma: Tekil Yedek', 'Çim biçme makinesinin tekerlek göbeği, ayar kolu ya da misina kafası tutucusu kırıldıysa numunenizden tekil üretiyoruz. Ölçüyü gönderin, siparişi verin.', _cim_bicme_bahce_makinesi_plastik_parca_yaptirma),
    ('ozel-parca-kac-gunde-hazir-olur', 'Özel Üretim Parça Kaç Günde Hazır Olur? Süre Kademeleri', 'Özel üretim parça kaç günde hazır olur? Ölçü, teyit, üretim ve gönderim kademelerinin gerçekçi süre aralıkları ve süreyi uzatan etkenler. Ölçünüzü iletin.', _ozel_parca_kac_gunde_hazir_olur),
    ('plastik-parcaya-vida-disi-acilir-mi', 'Plastik Parçaya Vida Dişi Açılır mı? Gömme Somun Seçeneği', 'Plastik parçaya vida dişi açılır mı? Diş sıyrılmasına karşı metal gömme somun, diş boyu ve cidar kalınlığını ölçünüze göre ayarlıyoruz. Ölçünüzü iletin.', _plastik_parcaya_vida_disi_acilir_mi),
]
