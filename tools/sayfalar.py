...
<p>Ölçüsü tam gelen tek adet işte de, revizyon veya karmaşık ölçü gerektiren işte de teslim süresi ölçü onayından sonra 3-5 iş günüdür. Ölçü netleşene kadar sayaç işlemez; tarihi ölçünüzü teyit ettiğimizde veririz.</p>
<h2>Ölçünüze göre ayarladığımız seçenekler</h2>
...
CONTENT_PAGES = [
    ...
    ('ozel-parca-kac-gunde-hazir-olur', 'Özel Üretim Parça Kaç Günde Hazır Olur?', 'Özel üretim parça kaç günde hazır olur? Ölçü, teyit, üretim ve gönderim kademelerinin gerçekçi süre aralıkları ve süreyi uzatan etkenler. Ölçünüzü iletin.', _ozel_parca_kac_gunde_hazir_olur),
