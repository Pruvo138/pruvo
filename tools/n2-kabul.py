...
def kabul_Z(calisma, once_imza):
    ...
    beklenen = {
        ...
        # 20 Agu (K229): UCUNCU KOVA — M6 (kol bozulur) + M7 (kol OLCULEMEDI ile
        # BIRLESTIRILIR) -> MUTANT 5 -> 7; K8 (defteri yok ev GECER + ayri jeton)
        # + K9 (defterli evde davranis degismedi, bos defter HALA RED)
        # -> KONTROL 7 -> 9. Sayilar BUYUDU: kapsam kaybi oranla gizlenemez.
        "parti-kapisi.py":    "MUTANT=7/7 HEDEF_KOL_ATFI=7/7 KONTROL=9/9",
