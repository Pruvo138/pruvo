...
// haritaUret DISA VERILIR: uretim yolunda ureticiyi kosturan TEK govde budur
// (tools/parite-marka-ekseni.js capraz kaynagi da buradan gecer). Ikinci bir python
// parcasi yazilirsa iki fail-closed kurali ayrisir ([[ikiz-tanim-sessiz-ayrisma]]).
// Fikstur tarafindaki bagimsiz cagri (parite-fikstur-test.js) BILEREK buraya baglanmaz.
module.exports = { markaReferansi, haritaUret, ReferansHatasi, URETEC_GIRDILERI };
