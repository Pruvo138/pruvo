...
function belgeKur() {
  ...
  const belge = {
    ...
    // icin `sayfaKur` daha ilk vm kosumunda `TypeError: document.addEventListener is
    // not a function` ile duruyor ve dosyadaki TUM nobetciler OLU kaliyordu — aracin
    // kendi agziyla "TEST ALTYAPI HATASI". Care kodu fiksture uydurmak DEGIL, fiksturu
    // gercek ortamin alt kumesi olacak sekilde tamamlamak (K194 emsali).
